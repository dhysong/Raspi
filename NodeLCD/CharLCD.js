...
var CharLCD = function (pin_rs, pin_e, pins_db){
...
CharLCD.prototype.Begin = function(cols, lines){
	if(lines > 1){
		numlines = lines;
		displayfunction |= LCD_2LINE;
		curline = 0;
...
CharLCD.prototype.Clear = function(){
...
CharLCD.prototype.Message = function(text){
